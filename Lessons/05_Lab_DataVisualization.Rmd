...
PeterPaul.chem.nutrients$sampledate <-km571k as.Date(PeterPaul.chem.nutrients$sampledate, format = "%Y-%m-%d")
...
ggplot(PeterPaul.chem.nutrients) +
  geom_point(aes(x=sampledate, y=temperature_C, color = depth), size = 0.5) + scale_color_viridis(option ="magma", direction = -1) +
  scale_x_dates(names = sampledate, breaks = 5) +
  xlab("Date")
