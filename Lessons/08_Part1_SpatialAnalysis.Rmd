...
## data has coordinates, but it is not yet in a data frame
...
sfc_GraingerHall <- st_sfc(sfg_GraingerHall,crs=4326) #4326 says that it is lat/long (coordinate reference system)
...
#coordinates are good for locating on maps, need to convert to another system to determine distance
