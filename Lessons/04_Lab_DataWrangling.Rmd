...
> Add notes here: climate change, oxidation, fish populations
...
NTL.phys.data.TuesdayLake.1990.1999 %>%
  filter(NTL.phys.data, lakename %in% c("Tuesday Lake") %>%
  filter(NTL.phys.data, year4 %in% c(1990:1999))

NTL.phys.data.TuesdayLake.1990.1999 <- filter(NTL.phys.data, year4 %in% (1990:1999) & lakename == "Tuesday Lake")
...
NTL.phys.data.TuesdayLake.1990.1999.July <-
  NTL.phys.data.TuesdayLake.1990.1999 %>%
...
NTL.phys.data.meanTemp <- NTL.phys.data.TuesdayLake.1990.1999.July %>%
  filter(depth == 0) %>%
  filter(!is.na(temperature_C)) %>%
  mean(NTL.phys.data.TuesdayLake.1990.1999.July)
