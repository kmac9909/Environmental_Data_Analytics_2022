...
---
ANOVA method for determining whether various populations have equal means
assumes - population variations are equal, populations are normally distributed
- is variability due to the levels being tested?
-Assumptions, normal distribution, variance is equal, observations are independent
## Objectives
...
- does the variance change if we categorize into multiple categories?
...
# Format ANOVA as aov
#very similar to the lm from previous lesson
