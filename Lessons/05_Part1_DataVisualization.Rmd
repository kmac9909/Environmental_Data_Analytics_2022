...
# Depth in the fields of limnology and oceanography is on a reverse scale. scale y reverse will put 
tempvsdepth <- 
...
print(Nutrientplot6)
#^where is the legend?^, difficult to make
...
print(Nutrientplot6)
#used fill, rather then color so you can see the area
